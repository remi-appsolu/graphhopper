...
public abstract class AbstractMatrixAlgorithm implements MatrixAlgorithm {
    ...
    public AbstractMatrixAlgorithm( Graph graph, FlagEncoder encoder, Weighting weighting, TraversalMode traversalMode )
    {
        ...
        outEdgeExplorer = graph.createEdgeExplorer(DefaultEdgeFilter.inEdges(flagEncoder)/* new DefaultEdgeFilter(flagEncoder, false, true)*/);
        inEdgeExplorer = graph.createEdgeExplorer(DefaultEdgeFilter.outEdges(flagEncoder)/* new DefaultEdgeFilter(flagEncoder, true, false)*/);
    }
}